...
const Modal = () => {
  ...
  const actionButton = (color: String, text: String, textColor:String) => (
    <span className={`px-6 py-4 items-center justify-center rounded-lg border border-1 border-gray-200 cursor-pointer active:text-red-700 flex items-center justify-center bg-${color} text-${textColor}`}>
      {text}
    </span>
  )
  ...
  return (
    modalOpen && <div className="">
      ...
      <div className="absolute top-48 right-56 h-[60rem] w-[46rem] bg-white p-12 rounded-3xl">
        ...
        <div className="text-2xl mt-20 flex flex-col gap-8">
        ...
        <div className="flex items-center mt-20 font-bold text-3xl text-gray-500 pb-16 border-b-2 border-gray-200">
        ...
        <div className="flex text-4xl justify-end mt-16 gap-12">
